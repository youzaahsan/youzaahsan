...
&nbsp;
[![Email](https://img.shields.io/badge/%20youzaahsan12%40gmail.com-0d0d1a?style=for-the-badge&logo=gmail&logoColor=00d4ff)](mailto:youzaahsan1@gmail.com)
...
>
> My work spans **healthcare systems**, **e-commerce platforms**, **AI-driven tools**, and **interactive 3D experiences**, giving me the breadth and depth to make an immediate senior-level contribution.
...
&nbsp;
<img src="https://img.shields.io/badge/🚀_Projects-16%2B_Delivered-7c3aed?style=for-the-badge&labelColor=0d0d1a" />
&nbsp;
...
<details open>
<summary>
<b>🎨 &nbsp;Interactive 3D Product Showcase Portfolio</b>
&nbsp;&nbsp;<img src="https://img.shields.io/badge/★_Featured-00d4ff?style=flat-square&labelColor=0d0d1a"/>
...
Developed an **immersive 3D product showcase** combining advanced WebGL rendering with smooth animation — demonstrating deep frontend engineering capability and premium UX design.

| Layer | What Was Built | Technical Depth |
|:---:|:---|:---|
| 🔮 **3D Engine** | Real-time WebGL rendering | Three.js scene, lighting, camera control |
...
<details open>
<summary>
<b>🎓 &nbsp;Student Profile Dashboard — React.js & TypeScript</b>
...
Built a **fully component-driven React + TypeScript dashboard** — demonstrating clean architecture, strong typing discipline, state management, and responsive UI design at a production standard.

| Layer | What Was Built | Technical Depth |
|:---:|:---|:---|
| ⚛️ **Frontend** | React + TypeScript SPA | Component-based architecture, full type safety |
...
<details open>
<summary>
<b>🎓 &nbsp;Student Profile Dashboard — HTML Vanilla Edition</b>
&nbsp;&nbsp;<img src="https://img.shields.io/badge/HTML5-E34F26?style=flat-square&logo=html5&logoColor=white"/>
&nbsp;<img src="https://img.shields.io/badge/CSS3-1572B6?style=flat-square&logo=css3&logoColor=white"/>
&nbsp;<img src="https://img.shields.io/badge/JavaScript-F7DF1E?style=flat-square&logo=javascript&logoColor=black"/>
</summary>
...
A **pure HTML/CSS/JS implementation** of the Student Profile Dashboard — built without frameworks to demonstrate strong fundamentals, DOM mastery, and layout precision without abstractions.

| Layer | What Was Built | Technical Depth |
|:---:|:---|:---|
| 🏗️ **Structure** | Semantic HTML dashboard | Zero-dependency, framework-free architecture |
| 🎨 **Styling** | Custom CSS layout system | Theme switching, responsive grid, card UI |
| ⚙️ **Logic** | Vanilla JS interactions | Status filtering, dynamic DOM manipulation |

&nbsp;&nbsp; 🔗 [View Repository: Student-Profile-Dashboard](#)
...
Built a **fully type-safe personal finance tracker** using TypeScript — demonstrating real-world application of strong typing, data modeling, and interactive UI state management.

| Layer | What Was Built | Technical Depth |
|:---:|:---|:---|
| 🔒 **Type Safety** | Full TypeScript implementation | Strongly-typed data models, interfaces, enums |
| 📊 **Core Logic** | Expense management engine | Add, categorize, filter, and summarize transactions |
| 🎨 **UI** | Clean, interactive interface | Real-time balance updates, responsive layout |
